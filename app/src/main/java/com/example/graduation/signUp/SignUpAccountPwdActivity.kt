...
import com.example.graduation.databinding.ActivitySignUpAccountPwdBinding
...
class SignUpAccountPwdActivity : AppCompatActivity() {

    private lateinit var binding: ActivitySignUpAccountPwdBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivitySignUpAccountPwdBinding.inflate(layoutInflater)
