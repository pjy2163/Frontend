...
import com.example.graduation.databinding.FragmentDeleteAccountCompletedBinding
import java.util.*


class DeleteAccountCompletedFragment: Fragment() {
    private lateinit var binding:FragmentDeleteAccountCompletedBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentDeleteAccountCompletedBinding.inflate(layoutInflater)
